            ...
            <div class="container-fluid">
                ...
                <form>
                    <div class="form-group">
                        <label for="formGroupExampleInput">Nomor Tiket*</label>
                        <input type="text" class="form-control" id="formGroupExampleInput" placeholder="...">
                    </div>
                    <div class="form-group">
                        <label for="formGroupExampleInput2">Nama Pengaju*</label>
                        <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="...">
                    </div>
                    <div class="form-group">
                        <label for="formGroupExampleInput">Nama Tiket*</label>
                        <input type="text" class="form-control" id="formGroupExampleInput" placeholder="...">
                    </div>
                    <div class="form-group">
                        <label for="formGroupExampleInput">Tanggal Ajuan*</label>
                        <input type="date" class="form-control" id="formGroupExampleInput" placeholder="...">
                    </div>
                    <div class="form-group">
                        <label for="formGroupExampleInput">Departemen*</label>
                        <select class="custom-select">
                                <option selected>Pilih Departemen</option>
                                <option value="1">Poli Gigi</option>
                                <option value="2">Poli Jantung</option>
                                <option value="3">Ruang IGD</option>
                                </select>
                    </div>
                    <div class="form-group">
                        <label for="formGroupExampleInput2">Masalah*</label>
                        <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="...">
                    </div>
                </form>

                <!-- Button Bawah -->
                <a href="<?php echo site_url('ambiltiket'); ?>" class="btn btn-primary"  >Ambil Tiket</a>
