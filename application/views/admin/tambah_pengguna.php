        ...
        <div class="container-fluid">
                ...
                <h1 class="h3 mb-2 text-gray-800">Tambah Data Pengguna</h1>
                    <div class="bg-white py-lg-5 card shadow mb-4">
                        <form class="col row-cols-lg-auto g-4 align-items-center" action="<?php echo site_url('User/simpanData') ?>" method="post">                         
                          ...
                          <div class="row mb-3 ml-12">
                            <label for="masalah" class="col-sm-2 col-form-label">Password</label>
                            <div class="col-sm-10">
