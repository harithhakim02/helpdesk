    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800">Edit Data Departemen</h1>
                    <div class="bg-white py-lg-5 card shadow mb-4">
                        <form class="col row-cols-lg-auto g-4 align-items-center" action="<?php echo site_url('Departemen/Update') ?>" method="post">
                        <input type="hidden" name="ID_DEPARTEMEN" value=" <?php echo $departemen->ID_DEPARTEMEN ?> ">                         
                          <div class="row mb-3 ml-12">
                            ...
                            <div class="col-8 text-center">
                                <input type="submit" class="col-3 btn btn-success" role="button" value="Simpan">
