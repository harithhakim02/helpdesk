    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800">Edit Data Inventory</h1>
                    <div class="bg-white py-lg-5 card shadow mb-4">
                        <form class="col row-cols-lg-auto g-4 align-items-center" action="<?php echo site_url('Inventory/Update') ?>" method="post">
                        <input type="hidden" name="ID_INVENTORY" value=" <?php echo $inventory->ID_INVENTORY ?> ">                         
                          <div class="row mb-3 ml-12">
                            <label for="masalah" class="col-sm-2 col-form-label">Nama Inventory</label>
                            <div class="col-sm-10">
                              <input type="text" class="form-control" name="NAMA_INVENTORY" value="<?php echo $inventory->NAMA_INVENTORY ?>">
                            </div>
                          </div>
