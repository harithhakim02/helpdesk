                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <div class="dataTables_length" id="dataTables_length">
                                            <form class="form-inline">
                                                <input class="form-control mr-sm-2" type="month" placeholder="Search" aria-label="Search">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div class="dataTable_filter" id="dataTable_filter">
                                            <a class="btn btn-secondary" href="<?php echo site_url('Tiket/print')?>">  <i class="fa fa-print"></i> Print</a>
                                        </div>
                                    </div>
                                </div>
                                <br>
                                        ...
                                        <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending" style="width: 68px;">Opsi</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $mhs->TEKNISI ?></td>
                                                        <td><?php echo $mhs->STATUS_TIKET ?></td>
                                                        <td>       
                                                        <a href="<?php echo site_url('Tiket/edit/'.$mhs->ID_TIKET)?>" class="btn btn-info">Edit</a>                                                                                                         
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                                            </tbody>
