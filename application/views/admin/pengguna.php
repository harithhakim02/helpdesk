            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a class="btn btn-primary" href="<?=site_url('user/tambahData')?>">Tambah Data</a>
                        </div>
                    <div class="card-body">
                                        ...
                                        <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending" style="width: 32px;">No telepon</th>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    ...
                                                    <td><?php echo $no++ ?></td>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo site_url('user/edit/'.$mhs->id_user)?>" class="btn btn-info btn-icon-split">
                                                        ...
                                                        <td>
                                                            <a href="<?php echo site_url('user/delete/'.$mhs->id_user)?>" class="btn btn-danger">
                                                                <span class="icon text-white-50">
