    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800">Tambah Data Inventory</h1>
                    <div class="bg-white py-lg-5 card shadow mb-4">
                        <form class="col row-cols-lg-auto g-4 align-items-center" action="<?php echo site_url('Inventory/simpanData') ?>" method="post">                         
