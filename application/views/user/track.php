...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <div class="bg-white py-lg-5">
              ...
              <form method="POST" action="<?php echo site_url('user/profil');?>">
                ...
                <div class="form-group row ml-5 mr-5">
                  ...
                  <div class="col-sm-10">
                    <input type="text" readonly class="form-control" id="email" name="email" value="<?=$user['nama_user']?>">
                  </div>
                </div>
                ...
                <div class="form-group row ml-5 mr-5">
                  ...
                  <div class="col-sm-10">
                  <input type="text"readonly class="form-control" id="departemen" name="departemen" value="<?=$user['departemen']?>">
                  </div>
                </div>
                ...
                <div class="form-group row justify-content-end ml-5">
                  <div class="col-sm-10">
                  <a href="<?= site_url('user/form_ubah_profil');?>"><button type="button" class="btn btn-primary">Ubah Profil</button></a>
